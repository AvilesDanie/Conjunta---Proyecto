...
/**
 * Pantalla de login para Comercializadora
 */
public class LoginComercializadoraFrame extends JFrame {
    
    private final LoginComercializadoraController loginController;
    private JTextField usernameField;
    private JPasswordField passwordField;
    private JButton loginBtn;
    private boolean passwordVisible = false;
    
    public LoginComercializadoraFrame() {
        this.loginController = new LoginComercializadoraController();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        JPanel mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gradient = new GradientPaint(
                    0, 0, new Color(230, 74, 25),
                    0, getHeight(), new Color(255, 138, 101)
                );
        ...
        try {
            ...
            if (imageURL != null) {
                ...
                System.out.println("✓ Logo ElectroQuito cargado correctamente desde: " + imageURL);
            } else {
                System.err.println("✗ No se encontró la imagen: images/logoPerfilElectroQuito.png");
            ...
            System.err.println("✗ Error al cargar logo ElectroQuito: " + e.getMessage());
            e.printStackTrace();
        ...
        // Título
        JLabel titleLabel = new JLabel("ElectroQuito", SwingConstants.CENTER);
        ...
        // Subtítulo
        JLabel subtitleLabel = new JLabel("Comercializadora", SwingConstants.CENTER);
            ...
            protected void done() {
                try {
                    ...
                    SessionManager.getInstance().login(
                        user.id, user.username, user.rol, "COMERCIALIZADORA"
                    );
                    
                    ToastNotification.showSuccess(LoginComercializadoraFrame.this, 
                    ...
                    ToastNotification.showError(LoginComercializadoraFrame.this, 
